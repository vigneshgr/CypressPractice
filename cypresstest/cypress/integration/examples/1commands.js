...
it('my first test case', function(){
    ...
    //parent child type element identification and alias usage
    ...
    //looping through the array to find the element based on a name. Useful in case of data table type elements
